# nvim-treesitter-queries-ralph

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-ralph/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-ralph/actions/workflows/validate.yml)

Neovim tree-sitter queries for **ralph**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-ralph",
...
- [ ] Changes are scoped to `ralph` — do not include files for other languages
